...
@endif
        ...
        @include('LaravelLogger::partials.scripts', ['activities' => $activities ?? null])
            ...
            <div class="col-sm-12">
                <div class="{{ $containerClass }} {{ $bootstrapCardClasses }}">
                    ...
                    <div class="panel-body">
                        @include('LaravelLogger::logger.partials.activity-table', ['activities' => $activities ?? null, 'hoverable' => true])
                    </div>
                </div>
            </div>
        </div>
