...
@include('LaravelLogger::partials.scripts', ['activities' => $userActivities ?? null])
                                ...
                                <li class="list-group-item">
                                    <dl class="dl-horizontal">
                                        ...
                                        @if($userDetails)
                                            ...
                                            @if(config('LaravelLogger.rolesEnabled'))
                                                <dt>{!! trans('LaravelLogger::laravel-logger.drilldown.labels.userRoles') !!}</dt>
                                                  @foreach ($userDetails->roles as $user_role)
                                                    ...
                                                    @elseif ($user_role->name == 'administration')
                                            ...
                                            <dd>{{$userDetails->$userNameField}}</dd>
                ...
                <div class="row">
                    <div class="col-xs-12 col-12">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                @include('LaravelLogger::logger.partials.activity-table', ['activities' => $userActivities ?? null])
                            </li>
                        </ul>
                        <br />
                    </div>
