<?php
if (file_exists(base_path('modules/Core/Config/sweetalert.php')))
    return require_once base_path('modules/Core/Config/sweetalert.php');
else
    return [
        ...
        */
        ...
        'timer' => env('SWEET_ALERT_TIMER', 100),
        ...
        */
        ...
        'customClass' => [
            ...
            'container' => env('SWEET_ALERT_CONTAINER_CLASS', 'my-14'),
