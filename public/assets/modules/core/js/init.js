...
window.alertConfirm = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
  var target,
      title,
      text,
      btn_confirm_text,
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          target = _args.length > 0 && _args[0] !== undefined ? _args[0] : 'body';
          title = _args.length > 1 && _args[1] !== undefined ? _args[1] : 'Are you sure?';
          text = _args.length > 2 && _args[2] !== undefined ? _args[2] : 'You won\'t be able to revert this!';
          btn_confirm_text = _args.length > 3 && _args[3] !== undefined ? _args[3] : 'Yes, do it!';
          btn_cancel_text = _args.length > 4 && _args[4] !== undefined ? _args[4] : 'No, cancel!';
          _context.next = 7;
          return Swal.fire({
            title: title,
            text: text,
...
window.formatCapacity = function (capacity) {
  var unit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'byte';
  ...
  var i = Math.floor(Math.log(capacity) / Math.log(k));
...
window.ajaxUpload = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            type = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : '';
            formData = new FormData();
            if (filename !== '') formData.append("file", file, filename);else formData.append("file", file);
            _context2.next = 6;
            return axios.post('/file/create?type=' + type, formData, {
              headers: {
...
window.ajaxUpdateFile = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return axios.put('/file/edit/' + id, data);
...
window.ajaxDeleteFile = /*#__PURE__*/function () {
...
window.ajaxGetFiles = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee5() {
  var params,
      _args5 = arguments;
