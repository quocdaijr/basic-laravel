...
<x-field::upload name="thumbnail" :oldValue="$category->thumbnailDetail->id ?? null" :options="['id'=>'thumbnail', 'class' => 'w-44', 'url' => getUrlFile($category->thumbnailDetail->path ?? '')]"/>
<x-field::upload name="cover" :oldValue="$category->coverDetail->id ?? null" :options="['id'=>'cover', 'class' => 'w-1/3', 'url' => getUrlFile($category->coverDetail->path ?? '')]"/>
