...
return [
    ...
    */
    ...
    'width' => env('SWEET_ALERT_WIDTH', '20em'),
    ...
    */
    ...
    'padding' => env('SWEET_ALERT_PADDING', '0.35rem'),
    ...
    */
    ...
    'customClass' => [
        ...
        'container' => env('SWEET_ALERT_CONTAINER_CLASS', 'my-14 h-auto-important'),
        'popup' => env('SWEET_ALERT_POPUP_CLASS', 'popup'),
        'header' => env('SWEET_ALERT_HEADER_CLASS', 'header'),
        'title' => env('SWEET_ALERT_TITLE_CLASS', 'title'),
        'closeButton' => env('SWEET_ALERT_CLOSE_BUTTON_CLASS', 'closeButton'),
        'icon' => env('SWEET_ALERT_ICON_CLASS', 'icon'),
        'image' => env('SWEET_ALERT_IMAGE_CLASS', 'image'),
        'content' => env('SWEET_ALERT_CONTENT_CLASS', 'content'),
        'input' => env('SWEET_ALERT_INPUT_CLASS', 'input'),
        'actions' => env('SWEET_ALERT_ACTIONS_CLASS', 'actions'),
        'confirmButton' => env('SWEET_ALERT_CONFIRM_BUTTON_CLASS', 'confirmButton'),
        'cancelButton' => env('SWEET_ALERT_CANCEL_BUTTON_CLASS', 'cancelButton'),
        'footer' => env('SWEET_ALERT_FOOTER_CLASS', 'footer'),
    ],
